  ...
  return (
    <div className="bg-[#0F1117] min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-5 relative overflow-hidden">
        ...
        {/* Glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-indigo-900/25 blur-[120px] rounded-full pointer-events-none" aria-hidden />
        ...
        <div className="relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-7 py-3.5 bg-[#6366F1] hover:bg-[#4F46E5] text-white text-[15px] font-semibold rounded-xl transition-all duration-200 hover:shadow-xl hover:shadow-indigo-500/25 hover:-translate-y-0.5"
            >
              Zur Startseite →
            </Link>
            <Link
