...
const STATUS_OPTIONEN: {
  ...
  },
  {
    ...
    aktiv:   'bg-amber-100 text-amber-700 ring-2 ring-offset-1 ring-amber-400',
    inaktiv: 'bg-white text-gray-400 border border-gray-200 hover:border-amber-200 hover:bg-amber-50',
  },
  {
    wert:    'freigegeben',
    label:   'Freigegeben',
...
export default function ProjektStatusButtons({
  ...
  const [aktuellerStatus, setAktuellerStatus] = useState<ProjektStatus>(initialStatus)
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Das Projekt wird als <strong>Abgeschlossen</strong> markiert. Dieser Status signalisiert, dass alle Arbeiten abgeschlossen sind.
            </p>
