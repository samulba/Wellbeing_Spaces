...
- Session 12: Sprint 6 – Notizen-System (Migration 015, NotizBlock-Komponente add/edit/delete, in Kunden/Projekte/Partner integriert), Projektdetailseite aufgewertet (Stats-Panel Budget-Auslastung+Freigabe-Kacheln, FreigabeLinkKarte mit Restlaufzeit+Erneuern-Button), Logo-Upload für Kunden+Partner (Migration 016 Storage-Buckets, LogoUpload-Komponente mit Hover-Overlay+Instant-Preview, in Detail- und Grid-Ansichten integriert). Build fehlerfrei. Push.
